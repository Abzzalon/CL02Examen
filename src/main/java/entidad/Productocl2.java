...
/**
 * The persistent class for the productocl2 database table.
 * 
 */
@Entity
@NamedQuery(name="Productocl2.findAll", query="SELECT p FROM Productocl2 p")
public class Productocl2 implements Serializable {
